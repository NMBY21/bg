    ...
    return (
      ...
      >
        <Flex style={{ justifyContent: "left" }}>
          <span className="">
             <h3 className="mt-2 mb-0  text-center">{data?.languageName}</h3>
          </span>
        </Flex>

        <Divider dashed />
        <div className="">
          <h6 className="text-muted text-uppercase mb-3">Language details</h6>
          <p>
            <RightCircleOutlined />
            <span className="ml-3 text-dark">
              Language Name: {data?.languageName}
            </span>
          </p>
          <p>
            <RightCircleOutlined />
            <span className="ml-3 text-dark">Short Code: {data?.languageShortCode}</span>
          </p>
          <p>
            <RightCircleOutlined />
            <span className="ml-3 text-dark">Description: {data?.languageDescription}</span>
          </p>
          <p>
            <RightCircleOutlined />
